import { OnInit, OnDestroy, OnChanges, AfterViewInit, SimpleChanges, ChangeDetectorRef, ElementRef, Renderer2, EventEmitter, TemplateRef } from '@angular/core';
...
export declare class NzCascaderComponent implements OnInit, OnDestroy, OnChanges, AfterViewInit, ControlValueAccessor {
    ...
    _getLabel(): string | TemplateRef<any>;
