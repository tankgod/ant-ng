...
import { ElementRef, AfterContentChecked, AfterContentInit, QueryList, NgZone, Renderer2, TemplateRef } from '@angular/core';
...
export declare class NzTabsNavComponent implements AfterContentChecked, AfterContentInit {
    ...
    _type: string;
    nzType: string;
    _tabBarExtraContent: TemplateRef<any>;
    ...
    readonly tabListScrollWidthHeightPix: any;
    readonly elementRefOffSetWidthHeight: any;
